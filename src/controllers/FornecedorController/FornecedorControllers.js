...
class FornecedorController {
    ...
    static criar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { tx_razao_social, tx_cpf_cnpj, tx_email, tx_telefone } = req.body;
            const result = yield FornecedorModel_1.default.criarFornecedor(tx_razao_social, tx_cpf_cnpj, tx_email, tx_telefone);
    ...
    static atualizar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield fornecedor.atualizarFornecedor(tx_razao_social, tx_cpf_cnpj, tx_email, tx_telefone);
            return res.status(result.result === "success" ? 200 : 400).json(result);
        });
    }
    // Deletar fornecedor

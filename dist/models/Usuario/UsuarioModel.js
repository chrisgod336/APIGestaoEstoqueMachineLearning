...
class Usuario {
    ...
    static loginUsuario(tx_email, tx_senha) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const sql_search = `SELECT * FROM db_gol.tb_usuario WHERE tx_email = $1 AND tx_senha = $2`;
    ...
    static criarUsuario(tx_nome, tx_email, tx_senha) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const sql_insert = `
                INSERT INTO db_gol.tb_usuario(tx_nome, tx_email, tx_senha, tx_tipo_usuario)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const sql_search = id_usuario
                    ? `SELECT * FROM db_gol.tb_usuario WHERE id_usuario = $1`
                    : `SELECT * FROM db_gol.tb_usuario ORDER BY id_usuario`;
    ...
    atualizarUsuario(tx_nome, tx_email, tx_senha) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const sql_update = `
                UPDATE db_gol.tb_usuario
                SET tx_nome = $1, tx_email = $2, tx_senha = $3
                WHERE id_usuario = $4
            `;
                yield (0, db_1.query)(sql_update, [tx_nome, tx_email, tx_senha, this.id_usuario]);
    ...
    deletarUsuario() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const sql_delete = `DELETE FROM db_gol.tb_usuario WHERE id_usuario = $1`;
                yield (0, db_1.query)(sql_delete, [this.id_usuario]);
                return {
                    result: 'success',
...
const teste = Usuario.buscarUsuario();
console.log(teste);
